...
PRODUCT_NAME := f16ref_dongle
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := f16ref_dongle
PRODUCT_MODEL := MBX dongle board (f16ref_dongle)
...
PRODUCT_COPY_FILES += \
	device/amlogic/f16ref_dongle/ump.ko:root/boot/ump.ko \
	device/amlogic/f16ref_dongle/mali.ko:root/boot/mali.ko \
	device/amlogic/f16ref_dongle/8192cu.ko:system/lib/8192cu.ko \
	device/amlogic/f16ref_dongle/cfg80211.ko:system/lib/cfg80211.ko \
	device/amlogic/f16ref_dongle/ath6kl_usb.ko:system/lib/ath6kl_usb.ko \
	device/amlogic/f16ref_dongle/cfg80211_ath6kl.ko:system/lib/cfg80211_ath6kl.ko \
	device/amlogic/f16ref_dongle/compat.ko:system/lib/compat.ko \
	device/amlogic/f16ref_dongle/rt3070sta.ko:system/lib/rt3070sta.ko \
	device/amlogic/f16ref_dongle/RT2870STA.dat:system/etc/Wireless/RT2870STA/RT2870STA.dat \
	device/amlogic/f16ref_dongle/libape.so:system/lib/libape.so \
	device/amlogic/f16ref_dongle/libfaad.so:system/lib/libfaad.so 
...
PRODUCT_COPY_FILES += device/amlogic/f16ref_dongle/dhd.ko:system/lib/dhd.ko
...
DEVICE_PACKAGE_OVERLAYS := device/amlogic/f16ref_dongle/overlay
...
# multitouch
PRODUCT_COPY_FILES += \
  device/amlogic/f16ref_dongle/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
