...
WIFI_DRIVER_MODULE_ARG  := "firmware_path=/etc/wifi/40181/sdio-sta.bin nvram_path=/etc/wifi/40181/nvram.txt"
WIFI_DRIVER_FW_PATH_STA :=/etc/wifi/40181/sdio-sta.bin
WIFI_DRIVER_FW_PATH_AP  :=/etc/wifi/40181/sdio-apsta.bin
#WIFI_DRIVER_FW_PATH_P2P :=/etc/wifi/40181/sdio-p2p.bin
